...
public class PlayerCharacter : Character
{
    ...
    [Range(0.5f, 10.0f)] [SerializeField] private float rotationSpeed = 8.0f;
    ...
    public override void Movement()
    {
        ...
        else
        {
            ...
            transform.rotation = Quaternion.Lerp(transform.rotation, serverRotation, rotationSpeed * Time.deltaTime);
        }
    }
